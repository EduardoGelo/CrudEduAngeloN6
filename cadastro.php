            ...
            <div class="card-body px-5 text-center">
              <div class="mt-md-3 pb-5">
                ...
                <div data-mdb-input-init class="form-outline form-white mb-4">
                  ...
                  <strong>Já existe um usuário com esse nome! Tente novamente</strong>
                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
                  }
                  ?>

                  <!-- usuario -->
                  <form action="verifyCadastro.php" method="post" data-parsley-validate>
                    <div data-mdb-input-init class="form-outline form-white mb-4 vw-75">
                      <input type="text" placeholder="Usuario*" name="user" id="inputUsuario"
                ...
                <a class="color-pink" href="login.php">Entrar se ja possuir uma conta.</a>
              </div>
            </div>
          </div>
        </div>
